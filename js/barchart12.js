...
var svg12 = d3.select("#chart12").append("svg")
...
d3.csv("assets/mydata.csv", type, function(error, data) {
    ...
    svg12.selectAll(".bar")
        ...
        .attr("height", function(d) {
            return Math.abs(y(d.cost12) - y(0));
        })
        .on("mouseover", function(d){
            // alert("Year: " + d.Year + ": " + d.cost12 + " cost12");
            d3.select("#_yr")
                .text("Year: " + d.Year);
            d3.select("#degrree")
                .text(d.cost12 + "cost12");
        });
